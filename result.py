...
def load(voc_fname, word_embeddings_fname):
    ...
    """
    voc_file = np.load('./data/vocab.txt')
    word_embeddings_file = np.load('nnlm_word_embeddings.npy')
...
voc_fname = './data/vocab.txt'
word_embeddings_fname = 'nnlm_word_embeddings.npy'
